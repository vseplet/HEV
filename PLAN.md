...
- [ ] Команда `hev dash` — запуск веб-интерфейса
- [ ] Использовать [@vseplet/morph](https://github.com/vseplet/morph) для UI
- [ ] Страница со списком процессов
- [ ] Запуск/остановка/перезапуск процессов через UI
- [ ] Просмотр логов в реальном времени
- [ ] Статус демона и системная информация
...
| `hev dash` | Запустить веб-интерфейс (Фаза 3) |
